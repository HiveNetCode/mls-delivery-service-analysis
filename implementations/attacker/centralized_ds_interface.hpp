...
public:
    ...
    CentralizedDSInterface(MaliciousClient<CentralizedDSInterface> & mlsClient,
        Network & network)
...
protected:
    ...
    {
        // TODO We could verify it, but the higher level does it already
...
private:
    MaliciousClient<CentralizedDSInterface> & mlsClient;
    Network & network;
